...
<head>
  ...
  <title>Vote | Vot'Rank</title>
  <!-- BOOTSTRAP CDN -->
  <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/bootstrap@4.5.3/dist/css/bootstrap.min.css" integrity="sha384-TX8t27EcRE3e/ihU7zmQxVncDAy5uIKz4rEkgIXeMed4M0jlfIDPvg6uqKI2xXr2" crossorigin="anonymous" />
  <!-- Custom CSS -->
  <link rel="stylesheet" href="<?= base_url() ?>/css/vote.css" />
</head>
...
<body>
  ...
  <div id="conteneurPrincipal">
    <form id="conteneurVote" action="<?= base_url() ?>/vote/index" method="post">
      <h1><?= $titre ?></h1> <br>
      <ol id="items">
    ...
    <p>Lien du vote : <?= current_url() ?></p>
    <button onclick="copyTextToClipboard(`<?= current_url() ?>`)">Copier lien</button>
  </div>

  <!-- SORTABLE JS SCRIPT -->
  <script src="https://cdn.jsdelivr.net/npm/sortablejs@latest/Sortable.min.js"></script>
  <!-- JS CUSTOM SCRIPT -->
  <script src="<?= base_url() ?>/js/vote.js"></script>
